...
public class BuckProjectForm {
  ...
  private BuckProjectForm() { }

  public static BuckProjectForm newInstance() {
    BuckProjectForm form = new BuckProjectForm();
  ...
  public static BuckProjectForm newInstance(String targets) {
    BuckProjectForm form = new BuckProjectForm();
    FlowLayout layout = new FlowLayout(FlowLayout.LEADING, PADDING, PADDING);
    form.outer = new JPanel(layout);
  ...
  public static BuckProjectForm newInstance(Project project) {
  ...
  public BuckProjectForm setText(String targetNames) {
    if (null == targetNames) {
  ...
  public BuckProjectForm reset() {
    field.setText(EMPTY_TARGET_LIST);
    return this;
  }

  public BuckProjectForm setEnable(boolean enabled) {
